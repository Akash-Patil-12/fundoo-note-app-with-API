...
import 'package:fundoo_notes_app/model/users-login.dart';
import 'package:fundoo_notes_app/model/users.dart';
...
class _LoginState extends State<Login> {
  ...
  List userData = [];
  List<Users> userDataFromApi = [];

  Future<void> getUserDataFromApi() async {
    await loginUser();
    //print(userDataFromApi);
                  ...
                  onPressed: () async {
                    ...
                    if (email.text != "" && password.text != "") {
                      for (int i = 0; i < userData.length; i++) {
                        ...
                        bool checkUserLogin = await loginUser();
